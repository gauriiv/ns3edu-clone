      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <h3 className="text-2xl font-bold text-blue-400 mb-4">NS3Edu</h3>
            <p className="text-gray-300 mb-4">
              The premier platform for learning network simulation and modeling 
              with NS3 framework. Master the art of network simulation.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm">
              © 2024 NS3Edu. All rights reserved.
            </div>
